...
function transpileGlobalVar(line) {
...
function transpileMainCall(ast) {
    const mainClass = ast.body.find(n => n.type === 'ClassDecl' && n.name === 'Main');
    if (!mainClass)
        return '';
...
function interpret(ast) {
    ...
    (0, fs_1.writeFileSync)('LambdaLang/dist/lambdalang.out.js', js);
